...
class TestBasicFunctionality:
    ...
    def test_configuration_validation(self):
        ...
        # 测试导入配置相关模块
        try:
            from config.config_v2 import JJZAccount, JJZConfig, AppConfig
    ...
    def test_utility_functions(self):
        ...
        with patch('service.cache.cache_service.RedisOperations'):
            service = JJZService()
            ...
            with patch('service.jjz.jjz_service.date') as mock_date:
                ...
                # 测试有效期计算
                days = service._calculate_days_remaining("2025-08-20 23:59:59")
                assert days == 5

                # 测试过期情况
                days = service._calculate_days_remaining("2025-08-10 23:59:59")
                assert days == 0  # 最小为0
